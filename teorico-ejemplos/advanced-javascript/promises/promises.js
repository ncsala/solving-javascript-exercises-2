...
promesa2
  .then(value3 => console.log('Promesa 2 - conserva valor original -', {value3}))
...
promesa3
.then(null, error2 => {return error2})
...
promesa3
  .then(null, error3 => {throw error3 + 5})
  // .then(e => {throw e+15}, null) //Si viniera como resuelta tmb se puede arrojar para rechazo
  .then(null, error4 => console.log('Promesa 3 - Se arroja error en promesa anterior para que no se resuelva -', {error4}))
...
promesa4
  ...
  .then(values => {throw values}) //65 se arroja a rejected
